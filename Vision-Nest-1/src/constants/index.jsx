export const features = [
    {
      ...
      caption: "Consultancy",
      title: "Consult for your future",
      text: "We Vision Nest , Provide top notch consultancy and guidence to the company to grow them with imensionally high speed and accuracy towards their goal. Consulting is the key to success in business world.",
      button: {
    ...
    },
    {
      ...
      caption: "Marketing",
      title: "Backbone of the Company",
      text: "Sit tight , We have your back. As mentioned marketing is the major problem the company can face in their downfall, We Provide complete plan integration for marketing to success.",
      button: {
  ...
  export const faq = [
    {
      id: "0",
      question: "Why Vision Nest?",
      answer:
        "As this is the best , executable , efficient and user friendly plaform where every dependencies can traverse and get benefit from this.",
    },
    {
      id: "1",
      question: "What Special does Vision Nest have?",
      answer:
        "It provides first ever automated analysis blend with human mind to grow with accurate , pricise and secure future goals.",
    },
    {
      id: "2",
      question: "Is there 24/7 support available?",
      answer:
        "Yes! Not only for Bomber , but this is open for all.",
    },
    {
      id: "3",
      question: "What your refund policy?",
      answer:
        "If we are unable to reach the desired goal , we ensure complete refund on Bomber Pack and 75 % return on rest of all.",
    },
    {
      id: "4",
      question: "Do we have Everything?",
      answer:
        "That's your question , Absolutely yes for every growing or starting company we have all the tools related to growth.",
    },
    {
      id: "5",
      question: "What happens when you need help?",
      answer:
        "Drop a direct email to the given email id in contact us section we will reach you out in a 12 hr span,",
    },
    {
      id: "6",
      question: "Can I upgrade my plan?",
      answer:
        "Yes , but in middle upgradation some extra charges may apply , you can check that on calc with 0% extra add.",
    },
    {
      id: "7",
      question: "Who can take subscription?",
      answer:
        "Anybody who wants growth in their business!!",
    },
    {
      id: "8",
      question: "Do you offer training for individuals and teams?",
      answer:
        "We also provide training to the teams who join us for future estimate of our goal",
    },
    {
      id: "9",
      question: "My payment got stuck while buying subscription wht can i do?",
      answer:
        "Chill , you will get notified as per banks agreement.",
    },
  ];
  ...
  export const plans = [
    ...
    },
    {
      ...
      icon: "/images/Bomber.png",
      logo: "/images/Vision-nest logo.png",
    },
    {
      id: "2",
      title: "Marketing",
