    ...
    <header className={clsx(
        ...
        <div className='container flex h-14 items-center max-lg:px-5'>
            <a className='lg:hidden flex-1 cursor-pointer z-2'>
                <img src='/images/Vision-nest logo.png' width={115} height={55} alt='logo' className='rounded-full p-5'/>
            </a>
            <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:w-full max-lg:left-0 max-lg:bg-s2 max-lg:opacity-0',isOpen ? "max-lg:opacity-100" : "max-lg:pointer-events-none")}>
                ...
                <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto'>
                    <ul className='flex max-lg:block max-lg:px-12'>
                        ...
                        <li className='nav-logo'>
                            <LinkScroll to='hero' offset={-200} spy smooth className={clsx('max-lg:hidden transition-transform duration-500 cursor-pointer')}>
